...
function isPalindrome2(str) {
    ...
    // Slice string (remove 1 and last char. And then recursively check the substring without the first and last characters. So each time the sting will be reduced.
